...
const Navbar = () => {
  ...
  return (
    <nav className="sticky top-0 z-10 block w-full max-w-full px-4 py-2 text-black-800 bg-white border rounded-none shadow-md h-max border-white/80 bg-opacity-80 backdrop-blur-2xl backdrop-saturate-200 lg:px-8  lg:py-4">
        ...
        <div className="flex items-center gap-4">
          <div className="hidden  mr-4 sm:block">
            <ul className="flex flex-col gap-4 mt-2 mb-4 sm:mb-0 sm:mt-0 sm:flex-row sm:items-center lg:gap-8 ">
              <li onClick={()=>{navigate('/home')}} className="block p-1 font-sans text-sm antialiased font-medium leading-normal text-blue-gray-900 hover:rounded-sm hover:bg-gray-200">
                <a href="#" className="flex items-center hover:underline ">
                  Home
                </a>
              </li>
              <li onClick={()=>{navigate('/product')}}className="block p-1 font-sans text-sm antialiased font-medium leading-normal text-blue-gray-900 hover:rounded-sm hover:bg-gray-200 ">
                <a href="#" className="flex items-center hover:underline ">
                  Product
                </a>
              </li>
              <li className="block p-1 font-sans text-sm antialiased font-medium leading-normal text-blue-gray-900 hover:rounded-sm hover:bg-gray-200">
                <a href="#" className="flex items-center hover:underline">
                  My Order
                </a>
              </li>
