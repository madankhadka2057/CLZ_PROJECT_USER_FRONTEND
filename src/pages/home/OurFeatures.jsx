    ...
    <div className="mx-auto max-w-7xl md:px-4 sm:px-6 lg:px-8">
          <div className=" mb-0 md:mb-8 lg:mb-10 flex justify-center  items-center flex-col gap-x-0 md:gap-y-2 lg:gap-y-0  max-md:max-w-lg max-md:mx-auto">
              ...
              {/* <div className="relative w-full text-center  lg:text-left lg:w-2/4">
                  ...
                  <a  className="flex flex-row items-center justify-center gap-2 text-base font-semibold text-indigo-600 lg:justify-start hover:text-indigo-700 ">Button CTA <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
